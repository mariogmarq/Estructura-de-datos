...
class Imagen {
   private:
    // Tipo de la imagen
    TipoImagen tipo;
    // Matrix, se almacena de forma lineal, PPM triple de longitud que PGM por
    // RGB
    byte* imagen;
   ...
   public:
     ...
     * @precond fila, columna y valor deben de estar en un rango válido
     */
     ...
     * columna
     * @precond fila y columna deben de estar en un rango valido, si no se
     * devolverá -1
    ...
    */
     ...
     * @param img imagen a imprimir
     */
    friend std::ostream& operator<<(std::ostream& os, const Imagen& img);

    /**
     * @brief sobrecarga del operador de entrada >>
     * @param is flujo de entrada
     * @param img imagen a escanear
     */
    friend std::istream& operator>>(std::istream& is, const Imagen& img);
};
 ...
 * @param img imagen a imprimir
 */
std::ostream& operator<<(std::ostream& os, const Imagen& img);
