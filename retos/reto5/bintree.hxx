...
template <typename T>
inline bintree<T>::bintree(const T &e)
                                ...
                                typename bintree<T>::node n)
{
  ...
  { // Reemplazar el receptor por un subárbol suyo.
    if (laraiz != n)
    {
...
template <typename T>
inline void bintree<T>::prune_left(typename bintree<T>::node n,
                                   bintree<T> &orig)
{
  assert(!n.null());
...
template <typename T>
inline void bintree<T>::prune_right(typename bintree<T>::node n,
                                    bintree<T> &orig)
{
  assert(!n.null());
...
/*____________________________________________________________ */
template <typename T>
inline void bintree<T>::insert_left(typename bintree<T>::node n,
                                    bintree<T> &rama)
{
  assert(!n.null());
...
template <typename T>
inline void bintree<T>::insert_right(typename bintree<T>::node n,
                                     bintree<T> &rama)
{
  assert(!n.null());
...
template <typename T>
inline bintree<T>::preorder_iterator::preorder_iterator()
{
...
template <typename T>
inline bintree<T>::preorder_iterator::preorder_iterator(bintree<T>::node n)
    : elnodo(n)
{
}

template <typename T>
inline bool bintree<T>::preorder_iterator::operator!=(
...
template <typename T>
inline T &bintree<T>::preorder_iterator::operator*()
{
  return *elnodo;
}
...
template <typename T>
inline bintree<T>::postorder_iterator::postorder_iterator()
{
}
...
template <typename T>
inline bool bintree<T>::postorder_iterator::operator!=(
...
template <typename T>
inline T &bintree<T>::postorder_iterator::operator*()
{
  return *elnodo;
}
...
template <typename T>
inline T &bintree<T>::level_iterator::operator*()
{
...
template <typename T>
inline bintree<T>::const_preorder_iterator::const_preorder_iterator()
{
}
...
template <typename T>
inline bool bintree<T>::const_preorder_iterator::operator!=(
...
template <typename T>
inline const T &bintree<T>::const_preorder_iterator::operator*() const
{
  return *elnodo;
}
...
bintree<T>::const_preorder_iterator::operator++()
{
  ...
  {
    while ((!elnodo.parent().null()) &&
           (elnodo.parent().right() == elnodo || elnodo.parent().right().null()))
      elnodo = elnodo.parent();
    if (elnodo.parent().null())
      elnodo = typename bintree<T>::node();
    else
...
template <typename T>
inline bintree<T>::const_inorder_iterator::const_inorder_iterator()
{
  elnodo = typename bintree<T>::node();
}

template <typename T>
inline bintree<T>::const_inorder_iterator::const_inorder_iterator(const const_inorder_iterator &i)
{
  elnodo = i.elnodo;
}
...
template <typename T>
inline bool bintree<T>::const_inorder_iterator::operator!=(
...
template <typename T>
inline const T &bintree<T>::const_inorder_iterator::operator*() const
{
  return *elnodo;
}
...
template <typename T>
inline bintree<T>::const_postorder_iterator::const_postorder_iterator()
{
  elnodo = typename bintree<T>::node();
}
...
template <typename T>
inline bool bintree<T>::const_postorder_iterator::operator!=(
...
template <typename T>
inline const T &bintree<T>::const_postorder_iterator::operator*() const
{
  return *elnodo;
}
...
template <typename T>
inline bintree<T>::const_level_iterator::const_level_iterator()
{
}
...
template <typename T>
inline bool bintree<T>::const_level_iterator::operator!=(
